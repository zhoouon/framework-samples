...
import com.zhoouon.rocketmq.constant.DelayMessageConstant;
 ...
 */
@Slf4j
public abstract class EnhanceMessageHandler<T extends RemoteDomainEvent> {
     ...
     * 延时等级
     */
    private static final int DELAY_LEVEL = DelayMessageConstant.TEN_SECOND;
    ...
    protected void handleRetry(T message) {
        ...
        if (!messageSource.startsWith(DelayMessageConstant.RETRY_PREFIX)) {
            message.setSource(DelayMessageConstant.RETRY_PREFIX + messageSource);
        }
