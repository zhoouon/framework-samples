...
/**
 * ShardingSphere 5.2.1 YAML representer.
 *
 * <p>兼容层：ShardingSphere 5.2.1 按 SnakeYAML 1.x 编译，其原类隐式调用 {@link Representer} 无参构造器；
 * Spring Boot 3.2.4 使用 SnakeYAML 2.2 已移除该构造器。此处复制原类实现并显式传入
 * {@link DumperOptions}，使该模块可在 SnakeYAML 2.x 下正常启动。</p>
 */
